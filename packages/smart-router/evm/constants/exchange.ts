import { ChainId, Token, WBNB, WETH9, WNATIVE } from '@pancakeswap/sdk'
import { bscTokens, bscTestnetTokens, BUSD, USDC, USDT, CAKE } from '@pancakeswap/tokens'

import { ChainMap, ChainTokenList } from '../types'

export const SWAP_ROUTER_ADDRESSES = {
  [ChainId.ETHEREUM]: '0x72B42b8d5e75be99c18859626b2105599DE37795',
...
export const ROUTER_ADDRESS: ChainMap<string> = {
  [ChainId.ETHEREUM]: '0x09315EdF46c84367D8A6EF5e16248139346c9faC',
...
export const SUGGESTED_BASES: ChainTokenList = {
  [ChainId.ETHEREUM]: [USDC[ChainId.ETHEREUM], WETH9[ChainId.ETHEREUM], CAKE[ChainId.ETHEREUM]],
